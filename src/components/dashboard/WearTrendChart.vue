...
const option = computed<EChartsOption>(() => ({
  ...
  xAxis: { type: 'category', data: store.wearHistory.map((item) => item.time), axisLabel: { color: '#60859b', fontSize: 9 }, axisLine: { lineStyle: { color: '#174a67' } } },
  yAxis: { type: 'value', min: 0, max: 0.5, axisLabel: { color: '#60859b', fontSize: 9 }, splitLine: { lineStyle: { color: 'rgba(43, 104, 137, .2)' } } },
